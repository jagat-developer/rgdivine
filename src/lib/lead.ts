...
export const quoteSchema = z.object({
  ...
  serviceType: z
    ...
    .min(1),
  propertyType: z.enum(["Home", "Apartment/Condo", "Office", "Retail", "Industrial", "Other"]).optional(),
  sqftTier: z.enum(["<500", "500-1000", "1000-2000", "2000-3500", "3500+"]).optional(),
...
export function buildQuoteEmail(payload: QuoteSubmission) {
  ...
  const body = [
    ...
    `Approx. sqft: ${payload.sqftTier || "Not specified"}`,
